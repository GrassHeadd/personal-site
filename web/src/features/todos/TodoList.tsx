...
/* The server page fetches the list and the session, so the first paint
   already has both — this component only handles interaction from there.
   initialTodos === null means the server couldn't load the list. */
